...
hadoop fs -mkdir /user/recommender/input/user_3200000;
...
hadoop fs -put ./employee_skill_ranks_part_{0..63}.json /user/recommender/input/user_3200000;
...
hadoop fs -put ./employee_year_experiences_part_{0..31}.json /user/recommender/input/user_3200000;
